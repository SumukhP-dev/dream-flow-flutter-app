...
class NotificationService:
    ...
    def get_user_tokens(self, user_id: UUID, platform: Optional[str] = None) -> list[dict]:
        """
    ...
    def update_notification_preferences(
        ...
        if bedtime_reminder_time is not None:
            preferences_data["bedtime_reminder_time"] = bedtime_reminder_time.isoformat()
        if streak_notifications_enabled is not None:
            preferences_data["streak_notifications_enabled"] = streak_notifications_enabled
        if story_recommendations_enabled is not None:
            preferences_data["story_recommendations_enabled"] = story_recommendations_enabled
