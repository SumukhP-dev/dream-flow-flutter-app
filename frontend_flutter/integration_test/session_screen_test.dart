...
void main() {
  ...
  group('Session Screen Tests', () {
    testWidgets('SessionScreen displays story content', (WidgetTester tester) async {
      // Create mock story experience
      const experience = StoryExperience(
        storyText: 'Once upon a time in a peaceful forest...\n\nThe story continues here.',
    ...
    testWidgets('Audio status text interpolation works correctly', (WidgetTester tester) async {
      const experience = StoryExperience(
      ...
      expect(
        audioStatusText.evaluate().isNotEmpty || errorText.evaluate().isNotEmpty,
        isTrue,
    ...
    testWidgets('SessionScreen handles frames gallery', (WidgetTester tester) async {
      const experience = StoryExperience(
    ...
    testWidgets('SessionScreen video card renders', (WidgetTester tester) async {
      const experience = StoryExperience(
        storyText: 'Test story',
        theme: 'Test Theme',
        audioUrl: 'https://example.com/audio.mp3',
