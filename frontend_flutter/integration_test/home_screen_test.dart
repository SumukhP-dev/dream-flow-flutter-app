...
void main() {
  ...
  group('Home Screen Tests', () {
    testWidgets('Home screen form fields are accessible', (WidgetTester tester) async {
      app.main();
      ...
      expect(textFields.evaluate().isNotEmpty || find.text('Evening Profile').evaluate().isNotEmpty, isTrue);
    });
    ...
    testWidgets('Story prompt field accepts input', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 3));
      ...
      if (homeScreen.evaluate().isNotEmpty) {
        ...
        if (textFields.evaluate().isNotEmpty) {
          ...
          expect(find.text('A magical journey through the stars'), findsOneWidget);
        }
      }
    });
  });
