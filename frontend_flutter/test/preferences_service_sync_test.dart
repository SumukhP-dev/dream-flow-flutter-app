...
void main() {
  group('PreferencesService Supabase Sync', () {
    ...
    test('saveProfile syncs all fields to Supabase', () async {
      ...
      expect(await prefs.getStringList('preferences'), ['nature', 'peace']);
      expect(await prefs.getStringList('favoriteCharacters'), ['Character1']);
      expect(await prefs.getStringList('calmingElements'), ['element1']);
    });
    ...
    test('saveProfile handles partial updates', () async {
      ...
      expect(await prefs.getString('ritual'), 'Initial routine');
    });
  });
}
