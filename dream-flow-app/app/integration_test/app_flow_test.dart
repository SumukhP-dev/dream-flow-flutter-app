...
void main() {
  ...
  group('End-to-End App Flow Tests', () {
    ...
    testWidgets(
        'Complete flow: sign in -> generate story -> playback -> feedback',
      ...
      final mockExperience = StoryExperience(
        storyText:
      ...
      expect(
          find.text('How did this session affect your mood?'), findsOneWidget);
    ...
    testWidgets('Story generation and navigation flow',
        (WidgetTester tester) async {
      // Launch app
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 3));
    ...
    testWidgets('Session screen playback controls',
        (WidgetTester tester) async {
