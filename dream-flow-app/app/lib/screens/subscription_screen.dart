...
import '../shared/payment_service.dart';
...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
    ...
    return Column(
      ...
      children: [
        ...
        _buildTierCard(
          ...
          period: 'forever',
          features: [
            'Unlimited stories (local models, zero cost)',
            '5 rotating themes',
            'Standard quality',
              ...
              children: [
                ...
                if (annualPrice != null && isPremium) ...[
                  Row(
                    ...
                    children: [
                      TextButton(
                        onPressed: showAnnual
                            ? () => setState(() => showAnnual = false)
                            : null, // Already on monthly, disabled
                        style: TextButton.styleFrom(
                          foregroundColor: showAnnual ? Colors.grey : Colors.blue,
                        ),
                      ...
                      TextButton(
                        onPressed: !showAnnual
                            ? () => setState(() => showAnnual = true)
                            : null, // Already on annual, disabled
                        style: TextButton.styleFrom(
  ...
  Future<void> _handleUpgrade(String tier) async {
    ...
    try {
      ...
      // Process payment
      await _paymentService.purchaseSubscription(tier);
      // Subscription is created, but we reload from backend to get latest state
