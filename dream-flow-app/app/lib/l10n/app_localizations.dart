...
abstract class AppLocalizations {
  ...
  /// Label for story prompt input
  ///
  /// In en, this message translates to:
  /// **'Story Seed'**
  String get storySeed;

  /// Label for user profile section
  ///
  /// In en, this message translates to:
  /// **'Evening Profile'**
  String get eveningProfile;

  /// Label for mood input field
  ///
  /// In en, this message translates to:
  /// **'Current mood'**
  String get currentMood;

  /// Label for ritual input field
  ///
  /// In en, this message translates to:
  /// **'Nightly ritual'**
  String get nightlyRitual;

  /// Label for favorite characters input
  ///
  /// In en, this message translates to:
  /// **'Favorite characters (comma separated)'**
  String get favoriteCharacters;

  /// Label for calming elements input
  ///
  /// In en, this message translates to:
  /// **'Calming elements (comma separated)'**
  String get calmingElements;
